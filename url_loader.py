...
with open("simclr_storage_queue/image_urls_encoded.txt", "w") as f:
  f.write("\n".join([decode_url(url) for url in open("simclr_storage_queue/image_urls_decoded.txt", "r").read().split("\n")]))
